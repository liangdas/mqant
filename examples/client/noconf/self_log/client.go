...
func (b *Beego) TInfo(span log.TraceSpan, format string, keyvals ...interface{}) {
	fmt.Printf(format, keyvals...)
	fmt.Printf("\n")
}

func (b *Beego) TDebug(span log.TraceSpan, format string, keyvals ...interface{}) {
	fmt.Printf(format, keyvals...)
	fmt.Printf("\n")
}

func (b *Beego) TWarning(span log.TraceSpan, format string, keyvals ...interface{}) {
	fmt.Printf(format, keyvals...)
	fmt.Printf("\n")
}

func (b *Beego) TError(span log.TraceSpan, format string, keyvals ...interface{}) {
	fmt.Printf(format, keyvals...)
	fmt.Printf("\n")
}
